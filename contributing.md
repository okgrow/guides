 ...
 * If changes are considerable, it is recommended to open an issue and start a discussion first, otherwise we make ask for considerable revisions before accepting.
